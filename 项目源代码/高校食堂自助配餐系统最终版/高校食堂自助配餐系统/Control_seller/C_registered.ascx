<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="C_registered.ascx.cs" Inherits="高校食堂自助配餐系统.Control_seller.registered" %>
...
<div class="left">
  <h2 style="margin-left:5%;"> 欢迎您的注册加盟</h2>
        <table class="table table-hover">
            ...
            <tr>
                <td>
                    <label>店铺名称：</label></td>
                <td>
                    <asp:TextBox ID="txtSell_storename" runat="server" CssClass="text" placeholder="请输入您的店铺名称"></asp:TextBox></td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtSell_storename" ErrorMessage="必须输入店铺名称"></asp:RequiredFieldValidator></td>
            </tr>

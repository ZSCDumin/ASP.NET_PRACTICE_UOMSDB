...
namespace DataAccess
{
    public class administrator
    {
        ...
        public object searchBOrderByOrderId(string buyAccount, int OrderId)
        {
            var result = from ot in sellDB.b_order_T
                         where ot.b_account.Equals(buyAccount)
        ...
        public object searchSOrderByOrderId(string sellAccount, int OrderId)
        {
            var result = from ot in sellDB.s_order_T
                         where ot.s_account.Equals(sellAccount)
